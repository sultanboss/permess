							...
							<div class="col-sm-12">
								...
								<div class="panel panel-default">
									<div class="panel_controls" style="border-bottom: none; min-height: 350px;">
										...
										?>
										<h4 class="heading_a">Return Challan: </h4>
										<div class="clear"></div>
										...
										<div id="c_ret_print" class="print">											
											<h4 class="heading_a text-center underline">Return Challan</h4>
											<div class="row">											
												<div class="col-sm-4">
													<p>To</p>
													<p style="font-size: 13px;"><b><?php echo $delivery[0]['delivery_company_name'];?></b></p>
