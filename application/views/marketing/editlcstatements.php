										...
										<div class="panel_controls">
											...
											<div class="row">	
												<div class="col-sm-12">	
	            									...
	            									{
	            									?>		
													<button class="btn btn-success btn-sm right" id="btn_product_submit" style="margin-top: 10px; margin-right: 10px;" type="submit"><span class="icon-refresh"></span> Update LC Statements</button>
													<?php
													}
													?>
												</div>
