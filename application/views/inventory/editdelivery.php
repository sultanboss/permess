										...
										<div class="panel_controls">
												...
												<div class="col-sm-12">	
													...
													<div class="form_sep">																
														<div class="col-sm-2">
															...
															<input id="delivery_company_name" name="delivery_company_name" class="form-control" type="text" data-required="true" value="<?php echo $del['delivery_company_name']; ?>">
														...
														<div class="col-sm-2">
															...
															<textarea id="delivery_address" name="delivery_address" class="form-control double-text" type="text" data-required="true"><?php echo $del['delivery_address']; ?></textarea>
														</div>													
														<div class="col-sm-2">
											...
											<div class="row">	
												<div class="col-sm-12">			
													...
													<button class="btn btn-info btn-sm right" id="btn_product_submit" style="margin-top: 10px; margin-right: 10px;" type="submit"><span class="icon-refresh"></span> Update Delivery</button>
													<?php
													}
													?>
												</div>	
